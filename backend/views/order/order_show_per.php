...
<form id="Form1" name="Form1" method="post" action="?r=order/order_show_per">
  ...
  <tr>
      ...
      <?php }?>
      <?php if ($info['is_paid'] == 2) { ?>
        <span style="color: #009900">已完成</span>
      <?php }?>
      <?php if ($info['is_paid'] == 3) { ?>
   ...
   <!--  <tr>
    ...
    <tr>
      ...
      <td style=" border-bottom:1px #CCCCCC dashed" ><?=date('Y-m-d H:i:s',$info['payment_time'])?></td>
    </tr>
		<tr>
    ...
    <tr>
      ...
      <td height="80" ><span style="font-size:14px;">
        ...
        <input name="submit3" type="submit" class="admin_submit" value="保存备注"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <br />
